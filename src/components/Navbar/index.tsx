        ...
        <>
            <nav className="flex justify-between mt-6 max-md:hidden">
                ...
                <ul className='flex gap-4 self-end font-normal relative text-md '>
                    <li className={`after:content-[''] after:bg-primaryColor after:h-1 after:w-full after:block after:hover:w-0 after:transition-all after:duration-300 after:ease-in-out`}><Link
                        to=''>Shop</Link></li>
